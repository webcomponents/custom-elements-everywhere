...
describe("basic support", function() {
  ...
  describe("no children", function() {
    it("can display a Custom Element with no children", function() {
      this.weight = 3;
      (new ComponentWithoutChildren()).$mount({target: scratch});
  ...
  describe("with children", function() {
    ...
    it("can display a Custom Element with children in a Shadow Root", function() {
      this.weight = 3;
      let component = new ComponentWithChildren();
    ...
    it("can display a Custom Element with children in a Shadow Root and pass in Light DOM children", function(done) {
      this.weight = 3;
      let component = new ComponentWithChildrenRerender();
      component.$mount({target: scratch});
      let root = component.$refs.root;
      let wc = root.querySelector("#wc");
      setTimeout(function() {
    ...
    it("can display a Custom Element with children in the Shadow DOM and handle hiding and showing the element", function() {
      this.weight = 3;
      let component = new ComponentWithDifferentViews();
      component.$mount({target: scratch});
      let root = component.$refs.root;
      let wc = root.querySelector("#wc");
      expectHasChildren(wc);
  ...
  describe("events", function() {
    it("can imperatively listen to a DOM event dispatched by a Custom Element", function() {
      this.weight = 3;
      let component = new ComponentWithImperativeEvent();
      component.$mount({target: scratch});
      let root = component.$refs.root;
      let wc = root.querySelector("#wc");
