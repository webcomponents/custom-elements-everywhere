  ...
  config.set({
    plugins: [
      ...
      require(path.resolve(
        __dirname,
        "../__shared__/karma-plugins/karma-mocha"
      )),
      "karma-sourcemap-loader",
      "karma-webpack",
      require(path.resolve(
        __dirname,
        "../__shared__/karma-plugins/karma-custom-html-reporter"
      )),
      require(path.resolve(
        __dirname,
        "../__shared__/karma-plugins/karma-custom-json-reporter"
      ))
    ],
    ...
    htmlReporter: {
      ...
      pageTitle: "Hyperapp + Custom Elements",
      groupSuites: true,
